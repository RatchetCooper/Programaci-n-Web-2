"use client"
import {Button, Divider, Card, CardContent, Box, Typography, Stack, TextField, Select, MenuItem} from "@mui/material";
...
export default function FiltersCampaigns({ onFilterSubmit }) {
                ...
                <Card sx={{ width: '100%', maxWidth: 345, backgroundColor: theme.palette.cardFilterColor.main, mt:4 }}>
                    <CardContent>
                        ...
                        <Select 
                            ...
                            fullWidth
                            sx={{
                                bgcolor: theme.palette.inputBackground.main,
                                '&:focus': {
                                  bgcolor: 'lightblue',
                                },
                              }}
                ...
                <Card sx={{ width: '100%', maxWidth: 345, backgroundColor: theme.palette.cardFilterColor.main, mt:4 }}>
                    ...
                    <Box sx={{ display: "flex", justifyContent: "center", px: 2 }}>
                        <TextField 
                            ...
                            type="search" 
                            helperText="Número máximo de jugadores"
                            fullWidth
                            InputProps={{
                                style: { color: 'white' },
                            }}
